...
sidebarTitle: "Graph"
description: "Graph<T> is LYNX's adjacency-list weighted graph. Models the city road network and powers BFS, DFS, and Dijkstra shortest-path routing for trip pricing."
---
