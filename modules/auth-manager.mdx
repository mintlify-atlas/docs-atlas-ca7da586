---
title: "AuthManager: User Registry and Authentication in LYNX"
...
<ResponseField name="getUserByDni" type="Passenger">
...
<ResponseField name="contarConductoresDisponibles" type="int">
...
<ResponseField name="getPassengerMinTotalSpentHeap" type="Passenger">
